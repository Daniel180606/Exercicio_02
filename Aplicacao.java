    ...
    public static void main(String[] args) throws Exception {
        ...
        while (opcao != 5) {
            ...
            if (opcao == 1) { 
                ...
                Apartamento novoApartamento = new Apartamento(endereco, quartos, metragem, aluguel);
                ...
                System.out.print("Digite o endereço do apartamento a ser atualizado: ");
                String enderecoAtualizar = scanner.nextLine();
                Apartamento apartamento = apartamentosDAO.getByEndereco(enderecoAtualizar);
                ...
                if (apartamento != null) {
                    ...
                    System.out.print("Nova metragem quadrada: ");
                    apartamento.setMetragem(scanner.nextDouble());
                ...
                System.out.println("\n==== Excluir Apartamento ===");
                System.out.print("Digite o endereço do apartamento a ser excluído: ");
                String enderecoExcluir = scanner.nextLine();

                if (apartamentosDAO.delete(enderecoExcluir)) {
